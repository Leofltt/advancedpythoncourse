...
class SQLiteBatchProductStorer:
    ...
    def store(self,
        ...
        db_cursor.executemany(f"INSERT INTO {self.table}(name, price, currency) VALUES(?, ?, ?)", products_list)

    @staticmethod
    def _convert_products_to_list(products: List[Product]) -> List[Tuple[str, float, str]]:
