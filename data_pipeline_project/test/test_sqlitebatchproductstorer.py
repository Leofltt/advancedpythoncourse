...
def expected_product_list():
    return [("product_1", 10.,  "dollar"), ("product_2", 10., "euro")]

@pytest.fixture
def expected_product_list_db():
...
def test_products_are_inserted_in_db(products, expected_product_list_db):
    try:
        create_db("dummy.db")
        ...
        assert products == expected_product_list_db
    finally:
        os.remove("dummy.db")
